      ...
      <div className={styles.inner}>
        <div className={styles.intro}>
          <h2 className={styles.heading}>
            Доставка та<br /><em>бронювання</em>
          </h2>
          <p className={styles.lead}>
            Замовте доставку страв або забронюйте столик у ресторанах CARTEL. Також допоможемо з SPA, готелями та «Банькою на дровах».
          </p>
        </div>
        ...
        <div className={styles.panel}>
          <div className={styles.visual}>
            <Image
              ...
              alt="Відпочинок у Буковелі з CARTEL"
              fill
          ...
          <div className={styles.formCard}>
            {status === 'success' ? (
              ...
              <form className={styles.form} onSubmit={handleSubmit} noValidate>
                ...
                <div className={styles.field}>
                  <label htmlFor="service">Що цікавить</label>
                ...
                <div className={styles.field}>
                  ...
                  <textarea id="comment" placeholder="Заклад, дата, кількість гостей..." rows={3} value={form.comment} onChange={set('comment')} />
                </div>
