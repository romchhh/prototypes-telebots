      ...
      <div className={styles.inner}>
        <div className={styles.intro}>
          <h2 className={styles.heading}>
            Записатись<br /><em>у клуб</em>
          </h2>
          <p className={styles.lead}>
            Залиште заявку — підберемо тренування, підписку або цифровий продукт під ваш рівень.
          </p>
        </div>
        ...
        <div className={styles.panel}>
          <div className={styles.visual}>
            <Image
              ...
              alt="Differ Sport — спортзал з панорамним видом на Львів"
              fill
          ...
          <div className={styles.formCard}>
            {status === 'success' ? (
              <div className={styles.success}>
                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" stroke="var(--differ-lime)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
              ...
              <form className={styles.form} onSubmit={handleSubmit} noValidate>
                ...
                <div className={styles.field}>
                  ...
                  <textarea id="comment" placeholder="Рівень, ціль, зручний час..." rows={3} value={form.comment} onChange={set('comment')} />
                </div>
                ...
                <button type="submit" className={styles.submit} disabled={!form.consent || status === 'loading'}>
                  {status === 'loading' ? 'Надсилання…' : 'Записатись'}
                  {status !== 'loading' && (
