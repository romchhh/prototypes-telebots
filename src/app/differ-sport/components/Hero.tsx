      ...
      <div className={styles.body}>
        <div className={styles.copy}>
          <h1 className={styles.headline}>
            Тренуйся <em>по-іншому</em>.<br />
            Клуб, підписка і плани<br />
            <em>одразу</em> після оплати
          </h1>
          <p className={styles.role}>{BRAND.role}</p>

          <div className={styles.stats} aria-label="Клуб">
            {STATS.map((stat) => (
        ...
        <div className={styles.cards} aria-label="Формати">
