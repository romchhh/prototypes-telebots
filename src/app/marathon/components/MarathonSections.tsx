      ...
      <section id="pro-marafon" className={`${styles.section} ${styles.light}`}>
        <div className={styles.container}>
          <div className={styles.introBlock}>
            <SectionTitle>Ви вже багато разів починали вивчати англійську?</SectionTitle>
            <div className={styles.splitIntro}>
              <div className={styles.splitLeft}>
                <div className={styles.prose}>
                  <p className={styles.proseLead}>Купували курси. Дивилися відео на YouTube. Вчили слова. Зберігали корисні таблиці.</p>
                  <p>Але коли потрібно сказати навіть просте речення англійською — <strong>слова просто зникають з голови.</strong></p>
                  <p className={styles.emphasis}>Знайомо?</p>
                  <p>Ви не ліниві. У вас немає проблем із пам&apos;яттю. Просто більшість людей вивчають англійську хаотично.</p>
                </div>
                <p className={styles.leadBox}>Саме тому ми створили 10-денний марафон, який допомагає не просто дивитися уроки, а <em>реально почати використовувати англійську.</em></p>
              </div>
            </div>
          </div>
