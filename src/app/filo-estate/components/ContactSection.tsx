      ...
      <div className={styles.inner}>
        <div className={styles.intro}>
          <h2 className={styles.heading}>
            Подберём недвижимость<br /><em>в Анталии</em>
          </h2>
          <p className={styles.lead}>
            Бесплатная консультация — расскажите о целях покупки, и мы отфильтруем рынок новостроек под ваш бюджет и сценарий.
          </p>
        </div>
        ...
        <div className={styles.panel}>
          <div className={styles.visual}>
            <Image
              ...
              alt="Современная недвижимость в Анталии — Filo Estate"
              fill
            ...
            <div className={styles.visualContent}>
              <p className={styles.visualText}>
                Инвестиции · Жизнь · ВНЖ · Рассрочка
              </p>
              ...
              <form className={styles.form} onSubmit={handleSubmit} noValidate>
                ...
                <div className={styles.row}>
                  <div className={styles.field}>
                    ...
                    <input id="name" type="text" placeholder="Ваше имя" value={form.name} onChange={set('name')} required />
                  </div>
                  <div className={styles.field}>
                    <label htmlFor="phone">Телефон</label>
                    <input id="phone" type="tel" placeholder="+90" value={form.phone} onChange={set('phone')} required />
                  </div>
                </div>
                <div className={styles.field}>
                  <label htmlFor="service">Сценарий</label>
                ...
                <div className={styles.field}>
                  ...
                  <textarea id="comment" placeholder="Бюджет, район, сроки..." rows={3} value={form.comment} onChange={set('comment')} />
                </div>
                <label className={styles.consent}>
                  <input type="checkbox" checked={form.consent} onChange={set('consent')} required />
                  <span>Отправляя форму, вы соглашаетесь на обработку персональных данных</span>
                </label>
