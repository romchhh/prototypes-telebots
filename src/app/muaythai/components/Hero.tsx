...
const CARDS = [
  {
    title: 'Клуби Києва',
    text: 'Зали в районах столиці та області — оберіть на карті.',
    image: BRAND.heroDesktop,
    href: '#kluby',
  },
  {
    title: 'Тренери',
    text: 'Збірна міста, дитячі групи та профі-напрям.',
    ...
    <section className={styles.hero}>
      <div className={styles.bg}>
        <Image
          ...
          alt="Муайтай у рингу — Київська федерація"
          fill
          priority
          sizes="100vw"
        ...
        <div className={styles.copy}>
          <div className={styles.titleRow}>
            <h1 className={styles.headline}>
              ...
              <span className={styles.headlinePlace}>у Києві</span>
            </h1>
            <p className={styles.sideLine}>
              Київська федерація муайтай — клуби, тренери та змагання за стандартами IFMA. Запишіться на пробне заняття.
            </p>
          </div>
          ...
          <a href="#kontakt" className={styles.cta}>
            ...
            <span className={styles.ctaLabel}>Записатися на пробне заняття</span>
