      ...
      <div className={styles.inner}>
        <div className={styles.intro}>
          <h2 className={styles.heading}>
            Записатися<br /><em>на тренування</em>
          </h2>
          <p className={styles.lead}>
            Залиште заявку — підберемо клуб, тренера або допоможемо з реєстрацією на змагання.
          </p>
        </div>
        ...
        <div className={styles.panel}>
          <div className={styles.visual}>
            <Image
              ...
              alt="Київська федерація муайтай — тренування"
              fill
          ...
          <div className={styles.formCard}>
            {status === 'success' ? (
              ...
              <form className={styles.form} onSubmit={handleSubmit} noValidate>
                <p className={styles.formTitle}>Заявка на пробне заняття</p>
                <div className={styles.row}>
                  <div className={styles.field}>
                    <label htmlFor="name">Імʼя</label>
                    <input id="name" type="text" placeholder="Ваше імʼя" value={form.name} onChange={set('name')} required />
                  </div>
                  <div className={styles.field}>
                ...
                <div className={styles.field}>
                  <label htmlFor="service">Запит</label>
                ...
                <div className={styles.field}>
                  ...
                  <textarea id="comment" placeholder="Район, вік, досвід..." rows={3} value={form.comment} onChange={set('comment')} />
                </div>
