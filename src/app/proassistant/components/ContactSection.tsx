...
export default function ContactSection() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('pa-service', onService)
    return () => window.removeEventListener('pa-service', onService)
  }, [])
      ...
      <div className={styles.inner}>
        <div className={styles.intro}>
          ...
          <p className={styles.lead}>
            Оберіть напрям — навчання або пошук асистента — і команда ProAssistant
            ...
            <form className={styles.form} onSubmit={handleSubmit} noValidate>
              <div className={styles.row}>
                <div className={styles.field}>
                  <label htmlFor="pa-name">Ім&apos;я</label>
                  <input
                    id="pa-name"
                    type="text"
              ...
              <div className={styles.field}>
                <label htmlFor="pa-service">Послуга</label>
                <div className={styles.selectWrap}>
                  <select id="pa-service" value={form.service} onChange={set('service')}>
              ...
              <div className={styles.field}>
                <label htmlFor="pa-comment">Коротко про запит</label>
                <textarea
                  id="pa-comment"
                  rows={4}
                  placeholder="Розкажіть, що потрібно: навчання чи підбір асистента…"
                  value={form.comment}
