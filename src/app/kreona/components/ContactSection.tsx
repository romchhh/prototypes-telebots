        ...
        <div className={styles.panel}>
          <div className={styles.visual}>
            <Image
              ...
              alt="Kreona Company — автомобілі з Європи"
              fill
            ...
            <div className={styles.visualContent}>
              <p className={styles.visualLabel}>Kreona Company</p>
              <p className={styles.visualText}>
                Підбір · Покупка · Продаж
              </p>
            ...
            {status === 'success' ? (
              ...
              <form className={styles.form} onSubmit={handleSubmit} noValidate>
                ...
                <div className={styles.field}>
                  ...
                  <textarea id="comment" placeholder="Марка, бюджет, країна..." rows={3} value={form.comment} onChange={set('comment')} />
                </div>
