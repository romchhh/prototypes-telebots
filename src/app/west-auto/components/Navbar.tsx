  ...
  return (
    <>
      <nav className={`${styles.nav} ${transparent && !scrolled ? styles.transparent : styles.solid}`}>
        <a href="/west-auto" className={styles.brand}>West Auto <span>Shipping</span></a>

        <div className={styles.center}>
          <a href="#kontakt">Послуги</a>
          <a href="#kontakt">Автопідбір</a>
      ...
      <div className={`${styles.drawer} ${menuOpen ? styles.open : ''}`} role="dialog" aria-modal="true">
        <div className={styles.drawerTop}>
          <a href="/west-auto" className={styles.drawerBrand} onClick={() => setMenuOpen(false)}>
            West Auto <span>Shipping</span>
          </a>
        ...
        <nav className={styles.drawerNav} aria-label="Мобільна навігація">
          ...
          <a href="#kontakt" onClick={() => setMenuOpen(false)}>Автопідбір</a>
